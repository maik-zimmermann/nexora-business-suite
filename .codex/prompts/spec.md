...
3. `branch_name`
    - Format: `codex/feature/<feature_slug>`
    - Example: `codex/feature/card-component`.
...
Before making any content, switch to a new Git branch using the `branch_name` derived from the `$ARGUMENTS`. If the branch name is already taken, then append a version number to it: e.g. `codex/feature/card-component-01`
